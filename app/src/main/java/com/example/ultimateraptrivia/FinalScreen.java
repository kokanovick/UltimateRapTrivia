...
public class FinalScreen extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Score> options = new FirebaseRecyclerOptions.Builder<Score>().setQuery(mbase.child("Rezultati:"),Score.class).build();
    ...
    private void writeToDatabase(){
        ...
        reference.push().setValue(new Score(total, editText.getText().toString()));
